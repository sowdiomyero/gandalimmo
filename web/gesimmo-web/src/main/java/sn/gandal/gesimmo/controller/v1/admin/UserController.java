 ...
 */
@Controller(value = "userV1Controller")
...
public class UserController {
    ...
    @RequestMapping(value = "/new", method = RequestMethod.POST, consumes = "application/json", headers = "content-type=application/x-www-form-urlencoded", produces = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
    ...
    String showFicheUser(Model model, @PathVariable(value = "id") Long idUser) {
    ...
    @RequestMapping(value = "/api/update", method = RequestMethod.POST, consumes = "application/json", headers = "content-type=application/x-www-form-urlencoded", produces = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
    EditUserDTO editUserForm(@RequestBody @Valid EditUserDTO editUserForm, HttpServletRequest request) {
        ...
        User editUser = metier.findUserById(editUserForm.getIdUser());
        ...
        if (!(nom.equals(nomUserSelected)) || !(prenom.equals(prenomUserSelected)) || !(telephone.equals(telephoneUserSelected)) || !(mail.equals(emailUserSelected))) {
            ...
            editUserForm.setMsg("Modification passée effectuée avec succés");
            editUserForm.setResultat(Subscriber.RETOUR_OK);
            return editUserForm;
        } else {
            editUserForm.setMsg("Aucune modification de champs n'a été reçue ....");
            editUserForm.setResultat(Subscriber.RETOUR_OK);
            return editUserForm;
        }
    ...
    @RequestMapping(value = "/profil/view", method = RequestMethod.GET)
    public @ResponseBody EditUserDTO editProfil(@RequestParam(value = "login") String login) {
        loginSaisi = login;
        EditUserDTO editUser = new EditUserDTO();
    ...
    @RequestMapping(value = "/password/update", method = RequestMethod.POST, consumes = "application/json", headers = "content-type=application/x-www-form-urlencoded", produces = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
    ...
    @RequestMapping(value = "/password/regenerate", method = RequestMethod.GET)
    public @ResponseBody
    ...
    @RequestMapping(value = "/api/bloquer", method = RequestMethod.GET)
    public @ResponseBody
    EditUserDTO bloquerCompteUser(@RequestParam(value = "idUser") Long idUser) {
       ...
       // idUserSaisi = idUser;
        editUser.setIdUser(idUser);
        editUser.setResultat(EditUserDTO.RETOUR_OK);
        editUser.setMsg("Blocage passé avec succés");
        return editUser;
    }
    //Bloquer un utilisateur

    @RequestMapping(value = "/api/debloquer", method = RequestMethod.GET)
    public @ResponseBody
    ...
    @RequestMapping(value = "/actif/list")
    ...
    @RequestMapping(value = "/inactif/list")
    ...
    // TODO algo à revoir
    @RequestMapping(value = "/password/regenerer", method = RequestMethod.POST)
    public @ResponseBody
