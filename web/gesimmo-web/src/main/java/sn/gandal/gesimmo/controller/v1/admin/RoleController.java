 ...
 */
@Controller(value = "roleV1Controller")
...
//    }
    ...
    String showFicheRole(Model model, @PathVariable(value = "id") Long idRole, RoleForm roleForm) {
    ...
    @RequestMapping(value = "/update", method = RequestMethod.POST, consumes = "application/json", headers = "content-type=application/x-www-form-urlencoded", produces = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
    ...
    //TODO doit être dans userController
    ...
    EditRoleDTO editRole(@RequestParam(value = "idRole") Long idRole) {
        ...
        idRoleSaisi = idRole;
        editRole.setIdRole(role.getIdRole());
    ...
    @RequestMapping(value = "/api/edit", method = RequestMethod.POST, consumes = "application/json",  produces = MediaType.APPLICATION_JSON_VALUE)
    public @ResponseBody
