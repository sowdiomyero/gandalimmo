 ...
 * @author ddiaw
 */
@Controller(value = "cartographieV1Controller")
...
public class CartographieController {
    ...
    Logger LOG = Logger.getLogger(CartographieController.class.getName());
    ...
    public String homePage(Model model) {
        ...
        localisationFormFilter.setdT(manager.getGesimmoMetierService().getTypeLicenceLocalite().get(0));
        localisationFormFilter.setdType(manager.getGesimmoMetierService().getTypeLicenceLocalite());
        model.addAttribute("localisationFormFilter", localisationFormFilter);
        return "carto/index";
    }
    
    
    @RequestMapping(value = "/zone/draw")
...
//        model.addAttribute("zoneRoute", "/cartographie/zone/add");
    ...
    @RequestMapping(value = "/zone/add", method = RequestMethod.POST, consumes = "application/json; charset=utf-8")
    public @ResponseBody
