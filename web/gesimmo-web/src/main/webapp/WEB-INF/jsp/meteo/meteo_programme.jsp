        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                    ...
                    <div><spring:message code="label.programme.recherche.etat.termine" /></div>
                </div>
            </div>
        </div>  
        <a href="#">
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                    ...
                    <div><spring:message code="label.programme.recherche.etat.demarre" /></div>
                </div>
            </div>
        </div>
        <a href="#">
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                    ...
                    <div><spring:message code="label.programme.recherche.etat.suspendu" /></div>
                </div>
            </div>
        </div>
        <a href="#">
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                    ...
                    <div><spring:message code="label.programme.recherche.etat.abandonne" /></div>
                </div>
            </div>
        </div>
        <a href="#">
