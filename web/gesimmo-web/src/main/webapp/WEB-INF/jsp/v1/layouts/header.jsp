        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="color:#FFFFFF">
            <ul class="nav navbar-nav">
                <sec:authorize  ifAnyGranted="ROLE_ADMIN,ROLE_SUPER_ADMIN">
                    <li class="dropdown">
                        <a href="${pageContext.request.contextPath}/home/index" class="dropdown-toggle" data-toggle="dropdown" style="font-weight: bold;color: #fff"><span
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <a href="${pageContext.request.contextPath}/localisation/list" style="font-weight: bold;"><span class="glyphicon"></span>  <spring:message code="label.header.localisation.tableau"  /></a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/cartographie/index" style="font-weight: bold;"><span class="glyphicon"></span> <spring:message code="label.header.localisation.cartographie"  /></a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/cartographie/zone/draw" style="font-weight: bold;"><span class="glyphicon"></span>  <spring:message code="label.header.localisation.zonage"  /></a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li>
                                <a href="#" style="font-weight: bold;" data-toggle="modal" class="showProfil " 
                                   data-id="<sec:authentication property="principal.username" />" >
                                    <span class="glyphicon glyphicon-cog"></span> 
                                    <spring:message code="label.header.profil.profil"  />
                                </a>
                            </li>
                            
                            <li>

                                <a href="${pageContext.request.contextPath}/user/list" style="font-weight: bold;">
                                    <span class="fa fa-users "></span> 
                                    <spring:message code="label.header.param.list.users"  />
                                </a>
                            </li>
                            <li>

                                <a href="${pageContext.request.contextPath}/role/list" style="font-weight: bold;">
                                    <span class="fa fa-cogs "></span> 
                                    <spring:message code="label.header.param.list.roles"  />
                                </a>
                            </li>
                            <li>

                                <a href="${pageContext.request.contextPath}/indicateur/list" style="font-weight: bold;">
                                    <span class="fa fa-signal "></span> 
                                    <spring:message code="label.header.param.list.indicateurs"  />
                                </a>
                            </li>

                  
                            <sec:authorize  ifAnyGranted="ROLE_ADMIN,ROLE_SUPER_ADMIN">
                                <li><a href="${pageContext.request.contextPath}/setting/index" style="font-weight: bold;">
                                        <span class="glyphicon glyphicon-wrench"></span> 
                                        <spring:message code="label.header.profil.param"  />
                                    </a>
                                </li>
                                </sec:authorize>
                            <li class="">
                                <a href="${pageContext.request.contextPath}/home/help"  style="font-weight: bold;">
                                    <span class="glyphicon glyphicon-question-sign"> </span> 
                                    <spring:message code="label.header.profil.aide"  />
                                </a>

                            </li>
                            <li class="divider"></li>
                            <li><a href="<c:url value="/j_spring_security_logout" />" style="font-weight: bold;"> 
                                    <span class="glyphicon glyphicon-off"></span> 
                                    <spring:message code="label.header.profil.deconnect"  />
                                </a>
                            </li>
