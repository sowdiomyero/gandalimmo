...
<form:form commandName="localisationFormFilter" action="${pageContext.request.contextPath}/localisationListFilterCarte" method="POST" id="localisationFilterFormulaireCarte">
    <div class="panel-heading bgcode" style=" ">
        <div>
...
<!--                <label class="label label-default" for="textarea">Message</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-11 btn-group" role="group">
                        <form:button id="btnSearch" type="submit"  class="btn btn-success" style="font-size: 11px">Search</form:button>
                        <form:button id="btnSendSms" type="button"  class="btn btn-default" style="font-size: 11px">Sms</form:button>
                        <form:button id="btnSendEmail" type="button"  class="btn btn-default" style="font-size: 11px">Email</form:button>
                    </div>
