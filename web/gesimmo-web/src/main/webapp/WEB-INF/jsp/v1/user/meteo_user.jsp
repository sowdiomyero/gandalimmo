...
<div class="col-lg-3 col-md-6">
    <div class="panel panel-green" style="border-color: #5cb85c;">
        ...
        <a href="${pageContext.request.contextPath}/user/actif/list">
            <div class="panel-footer ">
...
<div class="col-lg-3 col-md-6">
    <div class="panel panel-yellow" style=" border-color: #f0ad4e;">
        ...
        <a href="${pageContext.request.contextPath}/user/inactif/list">
            <div class="panel-footer">
        ...
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                    ...
                    <div>Utilisateurs surveillés</div>
                </div>
            </div>
        </div>
        <a href="#">
            <div class="panel-footer">
                <span class="pull-left">Voir les utilisateurs surveillés</span>
                <div class="clearfix"></div>
            </div>
        </a>
    </div>
