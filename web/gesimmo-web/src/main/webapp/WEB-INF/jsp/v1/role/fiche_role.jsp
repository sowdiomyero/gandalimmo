            ...
            <div class="col-md-10">
                ...
                <div class="panel panel-primary " >
                    ...
                    <div style="margin: 20px;" >
                        ...
                        <form:form commandName="roleForm" action="${pageContext.request.contextPath}/role/update" method="post" id="submitRoleFormUpdate">
                            <div class="form-group row "  >
                                    <div class="col-lg-3">
                    ...
                    <div style="margin: 20px;" >
                        <div class="form-group row "  >
                            <%@include file="../user/tableau_user.jsp" %>
                        </div>
                    </div>          
                </div>
            </div>
    ...
    <div class="modal fade modal-admin" id="viewUserModal" tabindex="-1" role="dialog" aria-labelledby="viewUserModal" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="width:900px; margin-left: -150px">
                <form commandName="editUserForm" action="${pageContext.request.contextPath}/user/update" method="post" id="editUserFormulaire">
                    <div class="modal-header">
                        <!--                        <button type="button" class="close" data-dismiss="modal"
                                                        aria-hidden="true">
                                                    <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
