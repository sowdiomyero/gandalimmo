...
<nav class='sidebar sidebar-menu-collapsed bgcode' style="z-index: 2"> 
            ...
            <ul class='level1'>
                 ...
                 <li class='active'> <a class='expandable' href='#' title='Dashboard'>
                    ...
                    <ul class='level2'>
                        <li> <a href='#' title='Traffic'>Niveau DG</a>

                        </li>
                        <li> <a href='#' title='Conversion rate'>Niveau DE</a>

                        </li>
                        <li> <a href='#' title='Purchases'>Niveau DSI</a>
                ...
                <li> <a class='expandable' href='#' title='Parkings'>
                        ...
                        <span class='expanded-element'>Locaux</span>
                    </a>
                    
                    <ul class='level2'>
                        <li> <a href='#' title='Traffic'>Appartements</a>

                        </li>
                        <li> <a href='#' title='Conversion rate'>Bureaux</a>

                        </li>
                        <li> <a href='#' title='Purchases'>Salle de formation</a>
                ...
                <li> <a class='expandable' href='#' title='Localisation'>
                        ...
                        <span class='expanded-element'>Locataires</span>
                    </a>
