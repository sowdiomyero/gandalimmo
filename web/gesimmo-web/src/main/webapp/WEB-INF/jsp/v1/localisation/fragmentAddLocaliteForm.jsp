...
<sec:authorize access="isAuthenticated()">
    <c:if test="${localisationForm.resultat == 1100}">
        ...
        <form:form commandName="localisationForm" action="${pageContext.request.contextPath}/localisation/new" method="post" id="addLocalisationFormulaire">
            ...
            <div class="panel-body" style="color: #000033">
                <fieldset><legend><spring:message code="label.localisation.modal.ajouter.panel.heading" /></legend>  
                    ...
                    <label class="pull-left" for="cleLocalite"><spring:message code="label.localisation.tableau.header.nom"/>  (Google) </label>
                    <form:input class="form-control cleLocalite" path="cleLocalite" id="cleLocalite" required="required"  placeholder="Cle de l'objet"/>
