...
<div class="table-responsive div-list" >
...
<!--                   <a href="#" data-id="${localisation.idLocalisation}" > -->
                        <div >
                            ...
                            <c:if test="${localisation.getDType() == 'SITE'}">
                                <img src="img/markers/hotel_0star.png"  style="height: auto; width: auto; max-height: 25px; max-width: 25px"/>
                             </c:if> 
                             <c:if test="${localisation.getDType() == 'BATIMENT'}">
                                 <img src="img/markers/villa.png" style="height: auto; width: auto; max-height: 25px; max-width: 25px" />
                             </c:if> 
