...
<sec:authorize access="isAuthenticated()">
    ...
    <div class="container-fluid" style="margin-left: 5px; margin-right: 5px; ">    
        ...
        <div class="row">
            ...
            <div  class="col-md-3 resizable" style="height: 475px; overflow-y: auto; border-right: 1px solid #EEE;" >
                 <%@include file="./tableaux/listeObjetsLocalisables.jsp" %>
            </div>
                ...
                <div class="row" style="margin-bottom: 15px">
                    <div class="col-lg-12" style="margin-left: 10px">                         
                        ...
                        <div class="row "  id="localisationItemArea" >
                            <%@include file="./fiches/ficheLocalisation.jsp" %>
                        </div> 
